...
It is also a lot easier to see just how many signals are being transmitted in such a short time. A small sample that takes around 5 seconds to write to a file produces the below waveform in Vivado, using the testbenches written to test the reading of signal data. You can see the 'detected' waveform, pulses very frequently indicating that a preamble has been detected. I think it is really quite interesting just how many signals are available to read and decode at any one time.  
<img width="1910" height="893" alt="image" src="https://github.com/user-attachments/assets/8c3e790a-ee58-4d51-aed3-bd47f791aa11" />
