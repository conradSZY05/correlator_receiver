...
``` ./rtl_sdr.exe -f 1090000000 -s 2000000 -g 40 -n 20000000 adsb_capture.bin ``` (frequency 1090 MHz, sampling rate of 2000000 MSPS, gain 40 dB, -n 20000000 is the number of samples to capture which took around 11 seconds)
